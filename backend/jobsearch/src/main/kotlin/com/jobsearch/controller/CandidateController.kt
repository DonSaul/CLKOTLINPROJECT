...
class CandidateController(private val userService: UserService) {
    ...
    fun searchCandidates(
        @RequestParam(required = false) salaryExpectation: Int?,
        ...
        val responseEntityList = userService.findCandidatesByFilter(salaryExpectation, jobFamilyId, yearsOfExperience)
