  ...
  return (
    <CardContainer>
      <Typography variant="h4" align="center" gutterBottom>
        <EmojiPeopleIcon fontSize="large" /> Create Vacancy{" "}
      ...
      <form onSubmit={handleSubmit}>
        ...
        <TextField
          label={
            <>
              <BusinessCenterIcon /> Vacancy Name
            </>
          }
          type="text"
          value={vacancyName}
        ...
        <TextField
          label={
            <>
              <MonetizationOnIcon /> Salary Expectations
            </>
          }
          type="number"
