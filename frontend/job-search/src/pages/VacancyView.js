            ...
            {vacancyData ? (
              <>
                <CardHeader
                  ...
                  subheader={vacancyData.companyName}
                />
                <CardContent>
                  <Typography
                    variant="subtitle1"
                  ...
                  >
                    ...
                    >
                      <Stack direction="row" spacing={2}>
                        ...
                        <Stack>{vacancyData.jobFamily.name}</Stack>
                      </Stack>
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      <Stack direction="row" spacing={2}>
                        ...
                        <Stack>{vacancyData.salaryExpectation}</Stack>
                      </Stack>
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      <Stack direction="row" spacing={2}>
                        ...
                        <Stack>{vacancyData.yearsOfExperience}</Stack>
                      </Stack>
                    </Grid>
                  </Grid>
                  <CardActions
                ...
                {vacancyData.manager.email === getUserEmail() ? (
                  ...
                  >
                    <div style={{ marginBottom: "20px" }}>
                      ...
                      <CandidatesTable
                        dataFromQuery={candidates}
                        fromVacancyView={true}
                      />
                    </div>
                  </CardContent>
                ) : null}
