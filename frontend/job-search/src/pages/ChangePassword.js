...
import {
  ...
  Link as MuiLink,
  Container,
} from "@mui/material"; // Import Container from Material-UI
...
const ChangePassword = () => {
  ...
  const { newPassword, setNewPassword, message, resetPassword } =
    useChangePassword();
    ...
    <CardContainer width="xs">
      ...
      <div>
        ...
        >
          ...
          {/* Add a label for confirming the new password */}
          <TextField
            type="password"
            id="confirmPassword"
        ...
        <Typography variant="body2" style={{ marginTop: "10px" }}>
          ...
          {/* Use MuiLink for Material-UI link styling */}
        </Typography>
      </div>
    </CardContainer>
  );
